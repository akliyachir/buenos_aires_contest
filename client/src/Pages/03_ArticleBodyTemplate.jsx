    ...
    <div className="ArticleBodyTemplate">
      ...
      <article>
        ...
        <p className="parag">
          ...
          village et découvrir l’action du temps et de l’eau sur la matière. Les
          charpentes et les baignoires métalliques ont rouillé, les bâtisses en
          béton se sont effondrées et les structures en bois ont résisté.
        </p>
        <p className="parag">
          La piscine municipale à ciel ouvert est définitivement abandonnée. En
          marge du village, vous découvrirez l’ancien abattoir, œuvre art déco
          du célèbre architecte argentin Francisco Salamone.{" "}
        </p>
        <h2 className="ttl">À quoi ressemble le village fantôme d’Epecuén?</h2>
        <p className="parag">
          Aujourd’hui, les vestiges qui ont déjà accueilli plusieurs tournages
          (dont ce clip de BirdPen réalisé par nos amis de Tango+Tango), se
          visitent librement.
        ...
        <p className="parag">
          Carhué, la ville la plus proche et point d’arrivée des bus, dispose de
          nombreux hébergements qui faciliteront votre venue.
        </p>
        <ul>
          <li>
